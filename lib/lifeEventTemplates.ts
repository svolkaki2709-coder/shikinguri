  ...
  },
  {
    ...
    items: [
      ...
      { kind: "income", name: "祝い金・ご祝儀", category: "結婚", amountMan: 200, repeatYears: 1, atAge: null,
        hint: "招待人数×3万円前後が目安（70人なら約210万円）。費用と同じ年に登録すると自己負担額が見えます" },
      { kind: "income", name: "出産育児一時金", category: "出産", amountMan: 50, repeatYears: 1, atAge: null,
        hint: "子ども1人につき50万円。出産費用と同じ年に登録すると、実際の持ち出しが見えます" },
      { kind: "income", name: "出産・子育て応援給付金", category: "出産", amountMan: 10, repeatYears: 1, atAge: null,
        hint: "妊娠届で5万円、出生届で5万円が目安。自治体により名称・金額が異なる" },
      { kind: "income", name: "出産手当金・育児休業給付金", category: "出産", amountMan: 150, repeatYears: 1, atAge: null,
        hint: "産休中は標準報酬日額の2/3、育休中は賃金の67%（181日目以降50%）。休業で減る収入の一部が戻る" },
